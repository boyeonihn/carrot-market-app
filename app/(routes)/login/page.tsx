...
export default function Login() {
  ...
  return (
    <main className="mt-16 px-4">
      <h3 className="text-3xl font-bold text-center">Login Carrot Market</h3>
      <div className="mt-8">
        {data?.ok ? (
          <form
          ...
          <>
            ...
            >
              ...
              {method === 'phone' ? (
                <Button text={'Get one time token'} />
              ) : null}
            </form>
          </>
        )}
        <div className="mt-6">
          ...
          <div className="grid grid-cols-2 gap-3 mt-6">
            <button className="flex justify-center items-center py-2 px-4 border border-gray-300 rounded-md shadow-sm bg-white text-sm font-medium text-gray-500 hover:bg-gray-500">
              <svg
                className="w-5 h-5"
                aria-hidden="true"
                fill="currentColor"
